"use strict";
var dayFifteen = function () {
    var lastOccurences = { 0: { "turn": 1, "previous": 0 }, 3: { "turn": 2, "previous": 0 }, 6: { "turn": 3, "previous": 0 } };
    var lastValue = 6;
    ...
    for (var i = 4; i < 2021; i++) {
        var lastOccurence = lastOccurences[lastValue];
        ...
        // rule 2
            ...
            var subtractedValue = lastOccurence.turn - lastOccurence.previous;
